...
# BBs 
    ...
    if (lttr == '\n'):
        continue
    elif (ord(lttr) < ord('A') or ord(lttr) > ord('z')):
        continue
    elif (ord(lttr) > ord('Z') and ord(lttr) < ord('a')):
        continue
    elif (smallcount ==1 and bigcount < 3):
        smallcount = 0
        bigcount = 0
    elif (smallcount ==2):
        smallcount = 0
        bigcount = 0
    elif (smallcount ==1 and bigcount ==6 ):
        if (word < 10):
            print(lttr, end='')
            word+=1
        else:
